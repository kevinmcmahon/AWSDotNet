...
set _DeploySetParametersFile=%RootPath%AWSWebApp.SetParameters.xml
)
...
:usage
echo =========================================================
if not exist "%RootPath%AWSWebApp.deploy-readme.txt" (
...
start notepad "%RootPath%AWSWebApp.deploy-readme.txt"
)
echo =========================================================
goto :eof
